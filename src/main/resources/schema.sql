...
ALTER TABLE User ADD FOREIGN KEY (docNumber) REFERENCES Document(docNumber);

CREATE INDEX IX_citizenshipCode ON User(citizenshipCode);
ALTER TABLE User ADD FOREIGN KEY (citizenshipCode) REFERENCES Country(citizenshipCode);
